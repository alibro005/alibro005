...
| **Cardio Predict** |  **BMW Car Price Predictor** |  **Hospital Management System** |
|------------------------|-------------------------------|-------------------------------------|
| Full-stack ML web application that predicts the likelihood of heart disease using a classification model. | Machine learning application that predicts used BMW car prices using vehicle specifications. | A Python-based Hospital Management System that combines Object-Oriented Programming, a Tkinter GUI, CLI options, and MySQL integration. |
...
|[Live](https://cardio-predict-gamma.vercel.app) | [Live](https://bmw-car-price-predictor.vercel.app) | [Repo](https://github.com/alibro005/Hospital-Management-System) |
